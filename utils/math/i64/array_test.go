...
func TestArrayEquips(t *testing.T) {
	RegisterTestingT(t)

	Ω(ArrayEquips(nil, nil)).Should(BeTrue())
	Ω(ArrayEquips(nil, []int64{})).Should(BeTrue())
	Ω(ArrayEquips([]int64{}, []int64{})).Should(BeTrue())
	Ω(ArrayEquips([]int64{1}, []int64{1})).Should(BeTrue())
	Ω(ArrayEquips([]int64{2, 1}, []int64{2, 1})).Should(BeTrue())

	Ω(ArrayEquips([]int64{1}, nil)).Should(BeFalse())
	Ω(ArrayEquips([]int64{1, 2}, []int64{1})).Should(BeFalse())
	Ω(ArrayEquips([]int64{1}, []int64{2})).Should(BeFalse())
	Ω(ArrayEquips([]int64{1, 2}, []int64{2, 1})).Should(BeFalse())
}
